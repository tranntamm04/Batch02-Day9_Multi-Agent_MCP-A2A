    ...
    messages = [
        SystemMessage(
            content=(
                ...
                'needs_privacy = true → question involves data, privacy, GDPR, CCPA, user consent'
            )
        ),
        HumanMessage(content=state["question"]),
    ]
...
Hãy phân tích các rủi ro về dữ liệu cá nhân, quyền riêng tư, consent, GDPR/CCPA nếu có.
Trả lời dưới 200 từ.
"""
